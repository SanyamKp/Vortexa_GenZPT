  ...
  return (
    <aside className={`app-sidebar ${isOpen ? 'open' : 'closed'}`}>
      ...
      <nav className="sidebar-nav">
        ...
        {/* You can add more buttons here for Reports, Clusters, etc. */}
